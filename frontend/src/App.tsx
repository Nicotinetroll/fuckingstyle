...
function App() {
  ...
  // All cards data - 13 total (3 top + 10 bottom for 2 rows of 5)
  const allCards: Card[] = [
    {
      id: 'candidate1',
      name: 'Patrik Jakubčo',
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            {/* Vote Button with thematic colors */}
            <motion.button
    ...
    <div style={{
      ...
      <style>{`
        ...
        @media (max-width: 1200px) {
          /* Switch to 3 columns for tablets */
        ...
        @media (max-width: 768px) {
          /* Switch to 2 columns for mobile */
          div[style*="gridTemplateColumns: 'repeat(5, 1fr)'"] {
            grid-template-columns: repeat(2, 1fr) !important;
          }
          
          /* Stack top cards vertically on mobile */
